...
![alt text](https://github.com/cmohammadc/Calculator-in-Android/blob/master/pic.png)

# That is simple canculator in android
## And it is my first experience in working with android but i really try to write clean code for this project
# totally i have one activity which is MainActivity
